...
#JAVA_OPTS='-server -Xms2000m -Xmx2000m -XX:PermSize=128m -XX:MaxNewSize=256m -XX:MaxPermSize=256m -XX:+UseParNewGC -XX:+UseConcMarkSweepGC -Djava.awt.headless=true'
